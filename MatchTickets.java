...
public class MatchTickets {
    public static void main(String[] args) {
        ...
        switch (ticketType){
            case"Normal": moneyForTickets=new BigDecimal(people).multiply(new BigDecimal("249.99")); break;
            case"VIP": moneyForTickets=new BigDecimal(people).multiply(new BigDecimal("499.99")); break;
