...
public class HotelRoom {
    ...
    public static void main(String[] args) {
        ...
        BigDecimal studioPrice;
        new BigDecimal("65.00");
        BigDecimal apartmentPrice;
        ...
        String studioInfo = String.format("Studio: %s lv.", decimalFormatter.format(studioRent));
        String apartmentInfo = String.format("Apartment: %s lv.", decimalFormatter.format(apartmentRent));
